...
class CourseRemoteDataSource {
  ...
  final String baseUrl = 'http://localhost/mycampus/api/courses';
  ...
  Future<List<CourseModel>> getCourses({
    ...
    try {
      ...
      if (semester != null) queryParams['semester'] = semester.toJson();
      ...
      if (response.statusCode == 200) {
        ...
        if (jsonResponse['success'] == true) {
          ...
          throw Exception(jsonResponse['message'] ?? 'Failed to load courses');
        }
      } else {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (jsonResponse['success'] == true) {
          ...
          throw Exception(jsonResponse['message'] ?? 'Course not found');
        }
      } else {
        throw Exception('HTTP ${response.statusCode}: ${response.body}');
      }
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        if (jsonResponse['success'] == true) {
          ...
          throw Exception(jsonResponse['message'] ?? 'Failed to create course');
        }
      } else {
        throw Exception('HTTP ${response.statusCode}: ${response.body}');
      }
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (jsonResponse['success'] == true) {
          ...
          throw Exception(jsonResponse['message'] ?? 'Failed to update course');
        }
      } else {
        throw Exception('HTTP ${response.statusCode}: ${response.body}');
      }
  ...
  Future<void> deleteCourse(String id) async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (jsonResponse['success'] != true) {
          throw Exception(jsonResponse['message'] ?? 'Failed to delete course');
        }
      } else {
        throw Exception('HTTP ${response.statusCode}: ${response.body}');
      }
  ...
  Future<void> toggleCourseStatus(String id, CourseStatus status) async {
    try {
      final headers = await _getHeaders();
      ...
      if (response.statusCode == 200) {
        ...
        if (jsonResponse['success'] != true) {
          throw Exception(jsonResponse['message'] ?? 'Failed to toggle course status');
        }
      } else {
        throw Exception('HTTP ${response.statusCode}: ${response.body}');
      }
    } catch (e) {
      throw Exception('Failed to toggle course status: $e');
    }
  }
